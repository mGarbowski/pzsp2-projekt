...
describe("Build Network", () =>{
  describe("Simple data", ()=>{
    ...
    const channels: EdgeSpectrumDataRow[] = [
      { edgeId: '1', channelId: '1', channel_label: 'CH-1', channelWidth: 50, frequency: 195,},
      { edgeId: '2', channelId: '1', channel_label: 'CH-1', channelWidth: 50, frequency: 195,}
    ]
