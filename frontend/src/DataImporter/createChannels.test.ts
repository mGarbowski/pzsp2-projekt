...
describe('Channels', () => {
  describe('getChannel', () => {
    it('should create ChannelEdge objects from edgeSpectrumRows', () => {
  ...
  describe("changeChannelEdgesToNodes", () => {
    ...
    it("Should handle edges with out of order nodes", () => {
      ...
      const channel: ChannelEdge = {id: '1', channel_label: 'CH-1', width: 50, frequency: 195, edges: ['1', '2', '3', '4']}
    ...
    it("Should handle out of order edges", () => {
      ...
      const channel: ChannelEdge = {id: '1', channel_label: 'CH-1', width: 50, frequency: 195, edges: ['2', '1', '4', '3']}
      const expectedNodes = ['1', '2', '3', '4', '5']
      expect(changeChannelEdgesToNodes(channel, edges)).toEqual(expectedNodes)
    })
